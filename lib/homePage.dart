    ...
    return Scaffold(
      body: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          if (constraints.maxHeight > 700 && constraints.maxHeight < 737) {
            return _buildWideContainersLow();
          }
          if (constraints.maxHeight > 700 && constraints.maxHeight < 815) {
            return _buildWideContainers();
          }
          if (constraints.maxHeight > 700 && constraints.maxHeight < 845) {
            return _buildWideContainersMax();
          }
          if (constraints.maxHeight > 700 && constraints.maxHeight < 927) {
            return _buildWideContainersMax();
          }
          else {
